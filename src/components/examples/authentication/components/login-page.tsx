    ...
    return (
        <div className="w-full min-h-screen overflow-hidden flex flex-col lg:flex-row">
            ...
            >
                ...
                <div className="flex flex-col justify-center h-full">
                    <blockquote className="space-y-2 max-w-[90%] lg:max-w-full">
                        ...
                        <TypographyH2 className="text-sm text-secondary-foreground/40 font-light lg:text-base leading-relaxed pt-4 text-left">
                            Start your journey with quick, secure, and reliable
                            access tailored for you.
                        </TypographyH2>
                    </blockquote>
                </div>
            </div>
            ...
            <div className="flex w-full lg:w-1/2 min-h-[50vh] lg:min-h-screen bg-background flex-col justify-center lg:p-12 xl:p-16">
                ...
                <div className="mx-auto w-full max-w-lg sm:w-[90%] md:w-[500px] lg:p-0 space-y-6">
                    ...
                    {/* MultiStepForm component instance for login */}
