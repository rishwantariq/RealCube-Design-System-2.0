/*! For license information please see 4011.de86c637.iframe.bundle.js.LICENSE.txt */
'use strict'
    ...
    [4011],
    {
        './node_modules/@radix-ui/react-dropdown-menu/dist/index.mjs': (
            ...
            function createContextScope(
                ...
                const createScope = () => {
                    const scopeContexts = defaultContexts.map(
                        (defaultContext) => react.createContext(defaultContext),
                    )
            ...
            function dispatchDiscreteCustomEvent(target, event) {
                target && react_dom.flushSync(() => target.dispatchEvent(event))
            }
            ...
            function createCollection(name) {
                ...
                const COLLECTION_SLOT_NAME = name + 'CollectionSlot',
                    CollectionSlot = react.forwardRef((props, forwardedRef) => {
                        ...
                        return (0, jsx_runtime.jsx)(dist.g7, {
                            ref: composedRefs,
                            children,
                        })
                    })
                ...
                const ITEM_SLOT_NAME = name + 'CollectionItemSlot',
                    CollectionItemSlot = react.forwardRef(
                        (props, forwardedRef) => {
                        ...
                        (event) => {
                            ...
                            if (isTabKey && focusedElement) {
                                const container2 = event.currentTarget,
                                    [first, last] = (function getTabbableEdges(
                                        container,
                                    ) {
                                        const candidates =
                                                getTabbableCandidates(
                                ...
                                first && last
                                    ? event.shiftKey || focusedElement !== last
                                        ? event.shiftKey &&
                                          ...
                                          loop &&
                                              dist_focus(last, { select: !0 }))
                                        : (event.preventDefault(),
                                          loop &&
                                              dist_focus(first, { select: !0 }))
            ...
            function useId(deterministicId) {
                ...
                return (
                    useLayoutEffect2(() => {
                        deterministicId ||
                            setId((reactId) => reactId ?? String(dist_count++))
                    }, [deterministicId]),
            ...
            function react_context_dist_composeContextScopes(...scopes) {
                const baseScope = scopes[0]
                if (1 === scopes.length) return baseScope
                const createScope = () => {
                    const scopeHooks = scopes.map((createScope2) => ({
            ...
            var [createPopperContext, createPopperScope] =
                    (function react_context_dist_createContextScope(
                        scopeName,
                        createContextScopeDeps = [],
                    ) {
                        let defaultContexts = []
                        ...
                        return (
                            ...
                            [
                                ...
                                react_context_dist_composeContextScopes(
                                    createScope,
                                    ...createContextScopeDeps,
                                ),
                            ]
            ...
            function _radix_ui_react_context_dist_composeContextScopes(
                ...scopes
            ) {
                const baseScope = scopes[0]
                if (1 === scopes.length) return baseScope
            ...
            var ENTRY_FOCUS = 'rovingFocusGroup.onEntryFocus',
                dist_EVENT_OPTIONS = { bubbles: !1, cancelable: !0 },
                ...
                [createRovingFocusGroupContext, createRovingFocusGroupScope] =
                    (function _radix_ui_react_context_dist_createContextScope(
                        scopeName,
                        createContextScopeDeps = [],
                    ) {
                        let defaultContexts = []
                        ...
                        return (
                            ...
                            [
                                ...
                                _radix_ui_react_context_dist_composeContextScopes(
                                    createScope,
                                    ...createContextScopeDeps,
                                ),
                            ]
            ...
            var RovingFocusGroupImpl = react.forwardRef(
                    (props, forwardedRef) => {
                        const {
                            ...
                            [currentTabStopId = null, setCurrentTabStopId] =
            ...
            function dist_focusFirst(candidates, preventScroll = !1) {
            ...
            var es2015_exports = __webpack_require__(
                ...
                react_style_singleton_dist_es2015 = __webpack_require__(
            ...
            const sidecar = (0, es2015_exports.L)(
                ...
                function RemoveScrollSideCar(props) {
                    var shouldPreventQueue = react.useRef([]),
                        ...
                        Style = react.useState(
                            react_style_singleton_dist_es2015.Ws,
                        )[0],
                    ...
                    var shouldCancelEvent = react.useCallback(function (
                            ...
                            return (function (
                                ...
                                return (
                                    ((isDeltaPositive &&
                                        ((noOverscroll &&
                                            Math.abs(availableScroll) < 1) ||
                                            (!noOverscroll &&
                                                delta > availableScroll))) ||
                                        (!isDeltaPositive &&
                                            ((noOverscroll &&
                                                Math.abs(availableScrollTop) <
                                                    1) ||
                                                (!noOverscroll &&
                                                    -delta >
                                                        availableScrollTop)))) &&
                    ...
                    return react.createElement(
                        ...
                        inert
                            ...
                            : null,
                        removeScrollBar
                            ? react.createElement(dist_es2015.jp, {
                                  gapMode: props.gapMode,
                              })
                            : null,
                    )
            ...
            var SELECTION_KEYS = ['Enter', ' '],
                ...
                ] = createCollection('Menu'),
                [createMenuContext, createMenuScope] = createContextScope(
                    'Menu',
                    [
                        dist_createCollectionScope,
                        createPopperScope,
                ...
                [MenuRootProvider, useMenuRootContext] =
            ...
            var [MenuContentProvider, useMenuContentContext] =
                ...
                MenuRootContentModal = react.forwardRef(
                    (props, forwardedRef) => {
                ...
                MenuRootContentNonModal = react.forwardRef(
                    (props, forwardedRef) => {
                        const context = useMenuContext(
                            'MenuContent',
                            props.__scopeMenu,
                ...
                MenuContentImpl = react.forwardRef((props, forwardedRef) => {
                    const {
                        ...
                        rovingFocusGroupScope =
                            useRovingFocusGroupScope(__scopeMenu),
                    ...
                    const isPointerMovingToSubmenu = react.useCallback(
                        (event) =>
                            ...
                            (function isPointerInGraceArea(event, area) {
                                ...
                                return (function isPointInPolygon(
                                    point,
                                    polygon,
                                ) {
                                    const { x, y } = point
                                                            ...
                                                            composeEventHandlers(
                                                                ...
                                                                (event) => {
                                                                    ...
                                                                    LAST_KEYS.includes(
                                                                        ...
                                                                        candidateNodes.reverse(),
                                                                        (function react_menu_dist_focusFirst(
                                                                            candidates,
                                                                        ) {
            ...
            var Root3 = Menu,
                ...
                [createDropdownMenuContext, createDropdownMenuScope] =
                    createContextScope('DropdownMenu', [createMenuScope]),
            ...
            var DropdownMenuRadioGroup = react.forwardRef(
                (props, forwardedRef) => {
            ...
            var DropdownMenuItemIndicator = react.forwardRef(
                (props, forwardedRef) => {
                    const { __scopeDropdownMenu, ...itemIndicatorProps } =
                            props,
                        menuScope = useMenuScope(__scopeDropdownMenu)
