    ...
    ;(() => {
        ...
        function _t(e, r) {
            ...
            if (e != null && typeof Object.getOwnPropertySymbols == 'function')
                for (
                    var o = 0, t = Object.getOwnPropertySymbols(e);
                    o < t.length;
                    o++
                )
                    r.indexOf(t[o]) < 0 &&
                ...
                ;(t.cancelHandler = function () {
                    ...
                    (t.attachObserver = function () {
                        ...
                        if (!N()) {
                            ...
                            i &&
                                ((t.observableElement &&
                                    t.observableElement === i) ||
                                    ((t.observableElement = i),
                                    t.resizeObserver.observe(i, g)))
                        }
                    }),
            ...
            return (
                ...
                (r.prototype.render = function () {
                    ...
                    switch (g) {
                        ...
                        case 'child':
                            if (
                                ((i = o), i.type && typeof i.type == 'string')
                            ) {
                                d.targetRef
        ...
        var Pr = ({ toggleId: e, elementsToHighlight: r = [] }) => {
            ...
            Wr = ({ elements: e, type: r }) =>
                a.createElement(
                    ...
                    null,
                    e.map((n, t) =>
                        a.createElement(Gr, { element: n, key: t, type: r }),
                    ),
                ),
            ...
            Jr = c.div(({ elementWidth: e, theme: r }) => ({
                ...
                borderBottom:
                    e > 450 ? 'none' : `1px solid ${r.appBorderColor}`,
                input: {
                    marginLeft: 10,
                    marginRight: 0,
                    marginTop: -1,
            ...
            Zr = c.button(
                ...
                ({ active: e, theme: r }) =>
                    e
                        ? {
                              opacity: 1,
                              borderBottom: `3px solid ${r.color.secondary}`,
                          }
                        : {},
            ),
            en = c.div({}),
        ...
        var nn = ({ tabs: e }) => {
                ...
                return h(
                    ...
                    e[t].items.length > 0
                        ? h(
                              ...
                              h(le, {
                                  toggleId: s,
                                  elementsToHighlight: rn(e[t].items),
                              }),
                          )
                        : null,
                    e[t].panel,
            ...
            sn = () => {
                ...
                return a.createElement(
                    ...
                    null,
                    r === 'initial' &&
                        a.createElement(K, null, 'Initializing...'),
                    r === 'manual' &&
                        a.createElement(
                            a.Fragment,
                            null,
            ...
            un = () => {
                ...
                return a.createElement(
                    ...
                    a.createElement(
                        ...
                        t === 0
                            ? ''
                            : a.createElement(Z, { status: 'neutral' }, t),
                    ),
                )
            }
        F.register(x, (e) => {
