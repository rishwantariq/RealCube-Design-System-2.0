/*! For license information please see components-examples-form-display-stories-display-page-stories.dba6124c.iframe.bundle.js.LICENSE.txt */
'use strict'
            ...
            (
                ...
                __webpack_require__.r(__webpack_exports__),
                    __webpack_require__.d(__webpack_exports__, {
                        ...
                        default: () => display_page_stories,
                    })
                var _DisplayPage$paramete,
                    _DisplayPage$paramete2,
                    ...
                    displayFormSchema = lib.Ry({
                        items: lib.IX(lib.Z_()).refine(
                            function (value) {
                    ...
                    defaultValues = { items: ['recents', 'home'] }
                function DisplayForm() {
                    var form = (0, index_esm.cI)({
                        resolver: (0, zod.F)(displayFormSchema),
                        defaultValues,
                    })
                    return __jsx(
                        ui_form.l0,
                ...
                var display_page_stories_jsx = react.createElement
                ...
                const display_page_stories = {
                    title: 'Examples/display',
                    component: function component() {
                        return display_page_stories_jsx(
                            'div',
                            { className: 'space-y-6' },
                            display_page_stories_jsx(
                                'div',
                                null,
                                display_page_stories_jsx(
                                    'h3',
                            ...
                            display_page_stories_jsx(separator.Z, null),
                            display_page_stories_jsx(DisplayForm, null),
                        )
                    },
                }
                var DisplayPage = {}
                DisplayPage.parameters = _objectSpread(
                    _objectSpread({}, DisplayPage.parameters),
                    {},
                    {
                        docs: _objectSpread(
                            _objectSpread(
                                {},
                                null ===
                                    (_DisplayPage$paramete =
                                        DisplayPage.parameters) ||
                                    void 0 === _DisplayPage$paramete
                                    ? void 0
                                    : _DisplayPage$paramete.docs,
                            ),
                            {},
                            {
                                source: _objectSpread(
                                    ...
                                    null ===
                                        (_DisplayPage$paramete2 =
                                            DisplayPage.parameters) ||
                                        void 0 === _DisplayPage$paramete2 ||
                                        null ===
                                            (_DisplayPage$paramete2 =
                                                _DisplayPage$paramete2.docs) ||
                                        void 0 === _DisplayPage$paramete2
                                        ? void 0
                                        : _DisplayPage$paramete2.source,
                                ),
                            },
                        ),
                    },
                )
                const __namedExportsOrder = ['DisplayPage']
            },
        './src/components/ui/button.tsx': (
            __unused_webpack_module,
            __webpack_exports__,
