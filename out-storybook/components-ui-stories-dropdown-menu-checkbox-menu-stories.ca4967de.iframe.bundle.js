/*! For license information please see components-ui-stories-dropdown-menu-checkbox-menu-stories.ca4967de.iframe.bundle.js.LICENSE.txt */
'use strict'
        ...
        './src/components/ui/stories/dropdown-menu-checkbox-menu.stories.ts': (
            ...
            __webpack_require__.r(__webpack_exports__),
                __webpack_require__.d(__webpack_exports__, {
                    ...
                    default: () => dropdown_menu_checkbox_menu_stories,
                })
            var _DropdownMenuCheckbox,
                _DropdownMenuCheckbox2,
            ...
            function DropdownMenuCheckboxesDemo() {
                var _React$useState = react.useState(!0),
                    ...
                    showStatusBar = _React$useState2[0],
                    setShowStatusBar = _React$useState2[1],
                    _React$useState3 = react.useState(!1),
                    _React$useState4 = (0, slicedToArray.Z)(
                        _React$useState3,
                        2,
                    ),
                    showActivityBar = _React$useState4[0],
                    setShowActivityBar = _React$useState4[1],
                    _React$useState5 = react.useState(!1),
                    _React$useState6 = (0, slicedToArray.Z)(
                        _React$useState5,
                        2,
                    ),
                    showPanel = _React$useState6[0],
                    setShowPanel = _React$useState6[1]
                return __jsx(
                    dropdown_menu.h_,
                    null,
                    __jsx(
                        dropdown_menu.$F,
                        { asChild: !0 },
                        __jsx(ui_button.z, { variant: 'outline' }, 'Open'),
                    ),
                    __jsx(
                        dropdown_menu.AW,
                        { className: 'w-56' },
                        __jsx(dropdown_menu.Ju, null, 'Appearance'),
            ...
            DropdownMenuCheckboxesDemo.displayName =
                'DropdownMenuCheckboxesDemo'
            const dropdown_menu_checkbox_menu_stories = {
                title: 'RealCube/dropdown-menu',
                component: DropdownMenuCheckboxesDemo,
                parameters: { layout: 'centered' },
            }
            var DropdownMenuCheckboxes = { args: {} }
            DropdownMenuCheckboxes.parameters = _objectSpread(
                _objectSpread({}, DropdownMenuCheckboxes.parameters),
                {},
                {
                    docs: _objectSpread(
                        _objectSpread(
                            {},
                            null ===
                                (_DropdownMenuCheckbox =
                                    DropdownMenuCheckboxes.parameters) ||
                                void 0 === _DropdownMenuCheckbox
                                ? void 0
                                : _DropdownMenuCheckbox.docs,
                        ),
                        {},
                        {
                            source: _objectSpread(
                                ...
                                null ===
                                    (_DropdownMenuCheckbox2 =
                                        DropdownMenuCheckboxes.parameters) ||
                                    void 0 === _DropdownMenuCheckbox2 ||
                                    null ===
                                        (_DropdownMenuCheckbox2 =
                                            _DropdownMenuCheckbox2.docs) ||
                                    void 0 === _DropdownMenuCheckbox2
                                    ? void 0
                                    : _DropdownMenuCheckbox2.source,
                            ),
                        },
                    ),
                },
            )
            const __namedExportsOrder = ['DropdownMenuCheckboxes']
        },
        './src/components/ui/button.tsx': (
            __unused_webpack_module,
            __webpack_exports__,
