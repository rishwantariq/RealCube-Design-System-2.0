        ...
        './node_modules/@radix-ui/react-dialog/dist/index.mjs': (
            ...
            const sidecar = (0, es2015_exports.L)(
                ...
                function RemoveScrollSideCar(props) {
                    var shouldPreventQueue = react.useRef([]),
                        ...
                        Style = react.useState(dist_es2015.Ws)[0],
            ...
            var aria_hidden_dist_es2015 = __webpack_require__(
                ...
                Dialog = (props) => {
                    ...
                    return (0, jsx_runtime.jsx)(DialogProvider, {
                        scope: __scopeDialog,
                        triggerRef,
                        contentRef,
                        contentId: useId(),
            ...
            var DialogOverlay = react.forwardRef((props, forwardedRef) => {
                ...
                return context.modal
                    ? (0, jsx_runtime.jsx)(Presence, {
                          present: forceMount || context.open,
                          children: (0, jsx_runtime.jsx)(DialogOverlayImpl, {
                              ...overlayProps,
                              ref: forwardedRef,
                          }),
                      })
            ...
            var DialogOverlayImpl = react.forwardRef((props, forwardedRef) => {
                    ...
                    return (0, jsx_runtime.jsx)(Combination, {
                        as: dist.g7,
                        allowPinchZoom: !0,
                ...
                DialogContent = react.forwardRef((props, forwardedRef) => {
                    ...
                    return (0, jsx_runtime.jsx)(Presence, {
                        ...
                        children: context.modal
                            ? (0, jsx_runtime.jsx)(DialogContentModal, {
                                  ...contentProps,
                                  ref: forwardedRef,
                              })
                            : (0, jsx_runtime.jsx)(DialogContentNonModal, {
                                  ...contentProps,
                                  ref: forwardedRef,
                              }),
                    })
            ...
            var DialogContentModal = react.forwardRef((props, forwardedRef) => {
                    ...
                    return (
                        ...
                        (0, jsx_runtime.jsx)(DialogContentImpl, {
                            ...props,
                            ref: composedRefs,
                ...
                DialogContentNonModal = react.forwardRef(
                    (props, forwardedRef) => {
                        ...
                        return (0, jsx_runtime.jsx)(DialogContentImpl, {
                            ...props,
                            ref: forwardedRef,
                            trapFocus: !1,
                            disableOutsidePointerEvents: !1,
                    ...
                    return (
                        ...
                        (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                            children: [
                                ...
                                (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                    children: [
                                        (0, jsx_runtime.jsx)(TitleWarning, {
                ...
                DialogTitle = react.forwardRef((props, forwardedRef) => {
                    ...
                    return (0, jsx_runtime.jsx)(Primitive.h2, {
                        id: context.titleId,
                        ...titleProps,
                        ref: forwardedRef,
                    })
            ...
            var DialogDescription = react.forwardRef((props, forwardedRef) => {
                ...
                return (0, jsx_runtime.jsx)(Primitive.p, {
            ...
            var [WarningProvider, useWarningContext] = (function createContext2(
                    rootComponentName,
                    defaultContext,
                ) {
                ...
                TitleWarning = ({ titleId }) => {
                    const titleWarningContext =
                            useWarningContext('DialogTitleWarning'),
                ...
                DescriptionWarning = ({ contentRef, descriptionId }) => {
                    const MESSAGE = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${
                        useWarningContext('DialogDescriptionWarning')
                            .contentName
                    }}.`
                    return (
                        react.useEffect(() => {
                ...
                react_dialog_dist_Root = Dialog,
                Trigger = DialogTrigger,
                dist_Portal = DialogPortal,
