            ...
            (
                ...
                function PopChild({ children, isPresent }) {
                    const id = (0, react.useId)(),
                        ...
                        { nonce } = (0, react.useContext)(MotionConfigContext._)
                    return (
                ...
                const PresenceChild = ({
                    ...
                    const presenceChildren = (0, use_constant.h)(
                            newChildrenMap,
                        ),
                        id = (0, react.useId)(),
                        memoizedOnExitComplete = (0, react.useCallback)(
                            (childId) => {
                    ...
                    return (
                        ...
                        (0, jsx_runtime.jsx)(PresenceContext.O.Provider, {
                            value: context,
                            children,
                        })
                    )
                ...
                const AnimatePresence = ({
                    ...
                    const presentChildren = (0, react.useMemo)(
                            () => onlyElements(children),
                            [children],
                        ),
                        presentKeys = presentChildren.map(getChildKey),
                        isInitialRender = (0, react.useRef)(!0),
                        pendingPresentChildren = (0, react.useRef)(
                            presentChildren,
                        ),
                        exitComplete = (0, use_constant.h)(() => new Map()),
                        [diffedChildren, setDiffedChildren] = (0,
                        react.useState)(presentChildren),
                        [renderedChildren, setRenderedChildren] = (0,
                        react.useState)(presentChildren)
                    ;(0, use_isomorphic_effect.L)(() => {
                        ...
                        for (let i = 0; i < renderedChildren.length; i++) {
                            ...
                            presentKeys.includes(key)
                                ...
                                : !0 !== exitComplete.get(key) &&
                                  exitComplete.set(key, !1)
                        }
                    }, [
                        renderedChildren,
                        presentKeys.length,
                    ...
                    if (presentChildren !== diffedChildren) {
                        ...
                        return (
                            ...
                            void setDiffedChildren(presentChildren)
                        )
                    }
                    const { forceRender } = (0, react.useContext)(
                                              ...
                                              exitComplete.forEach(
                                                  ...
                                                  isEveryExitComplete &&
                                                      (null == forceRender ||
                                                          forceRender(),
                                                      setRenderedChildren(
                                                          pendingPresentChildren.current,
                                                      ),
                                                      onExitComplete &&
                                                          onExitComplete())
                                          },
        ...
        './node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs':
            (
                ...
                function createDOMMotionComponentProxy(componentFactory) {
                    if ('undefined' == typeof Proxy) return componentFactory
                    const componentCache = new Map()
                    return new Proxy((...args) => componentFactory(...args), {
                        get: (_target, key) =>
                            'create' === key
                                ? componentFactory
                ...
                function resolveVariantFromProps(
                    ...
                    if (
                        ('string' == typeof definition &&
                            (definition =
                                props.variants && props.variants[definition]),
                ...
                const variantPriorityOrder = [
                    ...
                    time_conversion_secondsToMilliseconds = (seconds) =>
                        1e3 * seconds,
                ...
                const MotionGlobalConfig_skipAnimations = !1,
                    MotionGlobalConfig_useManualTiming = !1,
                ...
                function createRenderBatcher(
                    ...
                    const state = { delta: 0, timestamp: 0, isProcessing: !1 },
                        ...
                        steps = stepsOrder.reduce(
                            (acc, key) => (
                                (acc[key] = (function createRenderStep(
                                    runNextFrame,
                                ) {
                        ...
                        processBatch = () => {
                            const timestamp = MotionGlobalConfig_useManualTiming
                                ? state.timestamp
                                : performance.now()
                            ;(runNextFrame = !1),
                ...
                const isNumericalString = (v) =>
                        /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v),
                    checkStringStartsWith = (token) => (key) =>
                ...
                function getVariableValue(current, element, depth = 1) {
                    ...
                    const [token, fallback] = (function parseCSSVariable(
                        current,
                    ) {
                    ...
                    if (resolved) {
                        ...
                        return isNumericalString(trimmed)
                            ? parseFloat(trimmed)
                            : trimmed
                    }
                    ...
                    getTranslateFromMatrix =
                        ...
                        (_bbox, { transform }) => {
                                ...
                                return getPosFromMatrix(matrix3d[1], pos3)
                            {
                                ...
                                return matrix
                                    ? getPosFromMatrix(matrix[1], pos2)
                                    : 0
                            }
                        },
                ...
                function readAllKeyframes() {
                    toResolve.forEach((resolver) => {
                        resolver.readKeyframes(),
                            resolver.needsMeasurement &&
                                (anyNeedsMeasurement = !0)
                    })
                }
                class KeyframeResolver {
                    ...
                    cancel() {
                        this.isComplete ||
                            ((this.isScheduled = !1), toResolve.delete(this))
                    }
                    resume() {
                ...
                const hex = {
                    ...
                    color = {
                        test: (v) =>
                            rgba.test(v) || hex.test(v) || hsla.test(v),
                        parse: (v) =>
                            rgba.test(v)
                                ? rgba.parse(v)
                                : hsla.test(v)
                ...
                const complex = {
                        test: function test(v) {
                            ...
                            return (
                                isNaN(v) &&
                                'string' == typeof v &&
                                ((null === (_a = v.match(floatRegex)) ||
                                void 0 === _a
                                    ? void 0
                                    : _a.length) || 0) +
                                    ((null === (_b = v.match(colorRegex)) ||
                                    void 0 === _b
                                        ? void 0
                                        : _b.length) || 0) >
                                    0
                        ...
                        getAnimatableNone: function getAnimatableNone(v) {
                            ...
                            return createTransformer(v)(
                                parsed.map(convertNumbersToZero),
                            )
                        },
                    },
                    maxDefaults = new Set([
                ...
                class DOMKeyframesResolver extends KeyframeResolver {
                    ...
                    readKeyframes() {
                        ...
                        for (let i = 0; i < unresolvedKeyframes.length; i++) {
                            ...
                            if (
                                ...
                                isCSSVariableToken(keyframe))
                            ) {
                                const resolved = getVariableValue(
                                    keyframe,
                                    element.current,
                                )
                                void 0 !== resolved &&
                        ...
                        if (originType !== targetType)
                            if (
                                isNumOrPxType(originType) &&
                                isNumOrPxType(targetType)
                            )
                                for (
                                    let i = 0;
                                    i < unresolvedKeyframes.length;
                                    i++
                                ) {
                    ...
                    resolveNoneKeyframes() {
                        const { unresolvedKeyframes, name } = this,
                            noneKeyframeIndexes = []
                        for (let i = 0; i < unresolvedKeyframes.length; i++)
                            ('number' == typeof (value = unresolvedKeyframes[i])
                                ? 0 === value
                                : null === value ||
                                  'none' === value ||
                                  '0' === value ||
                            ...
                            (function makeNoneKeyframesAnimatable(
                                ...
                                for (
                                    ...
                                    'string' == typeof keyframe &&
                                        ...
                                        analyseComplexValue(keyframe).values
                                            .length &&
                                        (animatableTemplate =
                                            unresolvedKeyframes[i]),
                                        i++
                    ...
                    measureEndState() {
                        ...
                        ;(unresolvedKeyframes[finalKeyframeIndex] =
                            ...
                            (null === (_a = this.removedTransforms) ||
                            void 0 === _a
                                ? void 0
                                : _a.length) &&
                            ...
                            void 0 === now &&
                                time.set(
                                    frameData.isProcessing ||
                                        MotionGlobalConfig_useManualTiming
                                        ? frameData.timestamp
                                        : performance.now(),
                                ),
                            now
                ...
                class BaseAnimation {
                    ...
                    onKeyframesResolved(keyframes, finalKeyframe) {
                        ...
                        if (
                            !isGenerator &&
                            !canAnimate(keyframes, name, type, velocity)
                        ) {
                            if (instantAnimationState_current || !delay)
                                return (
                                    null == onUpdate ||
                                        onUpdate(
                                            getFinalKeyframe(
                ...
                function findSpring({
                    ...
                    ;(0, errors.K)(
                        duration <=
                            time_conversion_secondsToMilliseconds(maxDuration),
                        ...
                        dampingRatio < 1
                            ? ((envelope = (undampedFreq) => {
                              ...
                              (derivative = (undampedFreq) => {
                                  ...
                                  return (
                                      ((-envelope(undampedFreq) + safeMin > 0
                                          ? -1
                                          : 1) *
                                          ((d - e) * f)) /
                                      g
                            ...
                            : ((envelope = (undampedFreq) =>
                                  Math.exp(-undampedFreq * duration) *
                                      ((undampedFreq - velocity) * duration +
                                          1) -
                                  safeMin),
                              (derivative = (undampedFreq) =>
                                  Math.exp(-undampedFreq * duration) *
                    ...
                    if (
                        ((duration =
                            time_conversion_secondsToMilliseconds(duration)),
                        isNaN(undampedFreq))
                    )
                        return { stiffness: 100, damping: 10, duration }
                    {
                        ...
                        return {
                            stiffness,
                            damping:
                                2 * dampingRatio * Math.sqrt(mass * stiffness),
                            duration,
                        }
                    }
                }
                ...
                function spring({
                    ...
                    if (
                        ...
                        resolveSpring = (t) =>
                            ...
                            Math.exp(-undampedAngularFreq * t) *
                                (initialDelta +
                                    (initialVelocity +
                                        undampedAngularFreq * initialDelta) *
                                        t)
                    else {
                    ...
                    return {
                        calculatedDuration:
                            (isResolvedFromDuration && duration) || null,
                        next: (t) => {
                ...
                function inertia({
                    ...
                    const calcDelta = (t) =>
                            -amplitude * Math.exp(-t / timeConstant),
                ...
                function asRGBA(color) {
                    const type =
                        ((v = color), colorTypes.find((type) => type.test(v)))
                    var v
                    if (
                        ((0, errors.K)(
                            Boolean(type),
                ...
                const mixColor = (from, to) => {
                        ...
                        return (v) => (
                            (blended.red = mixLinearColor(
                                fromRGBA.red,
                                toRGBA.red,
                                v,
                            )),
                            (blended.green = mixLinearColor(
                                fromRGBA.green,
                                toRGBA.green,
                                v,
                            )),
                            (blended.blue = mixLinearColor(
                                fromRGBA.blue,
                                toRGBA.blue,
                                v,
                            )),
                ...
                function interpolate(
                    ...
                    if (
                        ...
                        return () => output[0]
                    if (2 === inputLength && input[0] === input[1])
                        return () => output[1]
                    input[0] > input[inputLength - 1] &&
                        ((input = [...input].reverse()),
                        (output = [...output].reverse()))
                    const mixers = (function createMixers(
                            output,
                            ease,
                            customMixer,
                        ) {
                    ...
                    return isClamp
                        ? (v) =>
                              interpolator(
                                  clamp(input[0], input[inputLength - 1], v),
                              )
                        : interpolator
                }
                ...
                function keyframes({
                    ...
                    const easingFunctions = ((ease) =>
                        ...
                        absoluteTimes = (function convertOffsetToTimes(
                            offset,
                            duration,
                        ) {
                ...
                const frameloopDriver = (update) => {
                    ...
                    percentToProgress = (percent) => percent / 100
                class MainThreadAnimation extends BaseAnimation {
                    constructor(options) {
                        ...
                        const { name, motionValue, element, keyframes } =
                                this.options,
                            KeyframeResolver$1 =
                                (null == element
                                    ? void 0
                    ...
                    initPlayback(keyframes$1) {
                        const {
                            ...
                            generatorFactory = isGenerator(type)
                                ? type
                    ...
                    onPostResolved() {
                        ...
                        this.play(),
                            'paused' !== this.pendingPlayState && autoplay
                    ...
                    tick(timestamp, sample = !1) {
                        ...
                        this.speed > 0
                            ...
                            sample
                                ...
                                : null !== this.holdTime
                                  ...
                                  : (this.currentTime =
                                        Math.round(timestamp - this.startTime) *
                                        this.speed)
                        const timeWithoutDelay =
                                this.currentTime -
                                delay * (this.speed >= 0 ? 1 : -1),
                            isInDelayPhase =
                                this.speed >= 0
                                    ? timeWithoutDelay < 0
                        ...
                        if (repeat) {
                            const progress =
                                Math.min(this.currentTime, totalDuration) /
                                resolvedDuration
                        ...
                        const isAnimationFinished =
                            null === this.holdTime &&
                            ('finished' === this.state ||
                                ('running' === this.state && done))
                        return (
                            isAnimationFinished &&
                                void 0 !== finalKeyframe &&
                    ...
                    get duration() {
                        const { resolved } = this
                        return resolved
                            ? millisecondsToSeconds(resolved.calculatedDuration)
                            : 0
                    }
                    get time() {
                    ...
                    set time(newTime) {
                        ;(newTime =
                            ...
                            null !== this.holdTime || 0 === this.speed
                                ...
                                : this.driver &&
                                  (this.startTime =
                                      this.driver.now() - newTime / this.speed)
                    }
                    get speed() {
                    ...
                    set speed(newSpeed) {
                        ...
                        ;(this.playbackSpeed = newSpeed),
                            hasChanged &&
                                (this.time = millisecondsToSeconds(
                                    this.currentTime,
                                ))
                    }
                    play() {
                        if (
                            (this.resolver.isScheduled ||
                    ...
                    sample(time) {
                        return (this.startTime = 0), this.tick(time, !0)
                    }
                }
                const acceleratedValues = new Set([
                    ...
                    generateLinearEasing = (easing, duration) => {
                        let points = ''
                        const numPoints = Math.max(Math.round(duration / 10), 2)
                        for (let i = 0; i < numPoints; i++)
                            points +=
                                easing(progress(0, numPoints - 1, i)) + ', '
                        return `linear(${points.substring(
                            0,
                            points.length - 2,
                        )})`
                    }
                function memo(callback) {
                    let result
                    return () => (
                        void 0 === result && (result = callback()), result
                    )
                }
                const supportsFlags = { linearEasing: void 0 }
                function memoSupports(callback, supportsFlag) {
                    const memoized = memo(callback)
                    return () => {
                        var _a
                        return null !== (_a = supportsFlags[supportsFlag]) &&
                            void 0 !== _a
                            ? _a
                            : memoized()
                    }
                ...
                function isWaapiSupportedEasing(easing) {
                    return Boolean(
                        ('function' == typeof easing &&
                            ...
                            !easing ||
                            ('string' == typeof easing &&
                                (easing in supportedWaapiEasing ||
                                    supportsLinearEasing())) ||
                            isBezierDefinition(easing) ||
                            (Array.isArray(easing) &&
                                easing.every(isWaapiSupportedEasing)),
                    )
                }
                ...
                function mapEasingToNativeEasing(easing, duration) {
                    return easing
                        ? 'function' == typeof easing && supportsLinearEasing()
                            ? generateLinearEasing(easing, duration)
                            : isBezierDefinition(easing)
                ...
                class AcceleratedAnimation extends BaseAnimation {
                    ...
                    initPlayback(keyframes, finalKeyframe) {
                        ...
                        if (
                            !(null === (_a = motionValue.owner) || void 0 === _a
                                ? void 0
                                : _a.current)
                        )
                            return !1
                        if (
                            ...
                            const {
                                ...
                                pregeneratedAnimation =
                                    (function pregenerateKeyframes(
                                        keyframes,
                                        options,
                                    ) {
                            ...
                            1 ===
                                (keyframes = pregeneratedAnimation.keyframes)
                                    .length && (keyframes[1] = keyframes[0]),
                ...
                class GroupPlaybackControls {
                    ...
                    attachTimeline(timeline, fallback) {
                        const subscriptions = this.animations.map(
                            (animation) =>
                    ...
                    runAll(methodName) {
                        this.animations.forEach((controls) =>
                            controls[methodName](),
                        )
                    }
                    play() {
                ...
                const animateMotionValue =
                        ...
                        (onComplete) => {
                            ...
                            elapsed -=
                                time_conversion_secondsToMilliseconds(delay)
                            let options = {
                            ...
                            return !isHandoff &&
                                AcceleratedAnimation.supports(options)
                                ? new AcceleratedAnimation(options)
                                : new MainThreadAnimation(options)
                        },
                    isCustomValue = (v) =>
                        Boolean(
                            v && 'object' == typeof v && v.mix && v.toValue,
                        ),
                            ...
                            (this.updateAndNotify = (v, render = !0) => {
                                ...
                                this.updatedAt !== currentTime &&
                                    ...
                                    render &&
                                        ...
                                        this.events.renderRequest.notify(
                                            this.current,
                                        )
                            }),
                            (this.hasAnimated = !1),
                ...
                function shouldBlockAnimation(
                    ...
                    const shouldBlock =
                        protectedKeys.hasOwnProperty(key) &&
                        !0 !== needsAnimating[key]
                ...
                function animateTarget(
                    ...
                    for (const key in target) {
                        const value = visualElement.getValue(
                                key,
                                null !==
                                    (_a = visualElement.latestValues[key]) &&
                                    void 0 !== _a
                                    ? _a
                                    : null,
                            ),
                ...
                function animateVariant(visualElement, variant, options = {}) {
                    ...
                    const resolved = resolveVariant(
                        ...
                        variant,
                        'exit' === options.type
                            ? null === (_a = visualElement.presenceContext) ||
                              void 0 === _a
                                ? void 0
                                : _a.custom
                            : void 0,
                            ...
                            animations.map(({ animation, options }) =>
                                (function animateVisualElement(
                                    ...
                                    if (
                                        ...
                                        const animations = definition.map(
                                            (variant) =>
                                                animateVariant(
                                                    visualElement,
                                                    variant,
                ...
                function createAnimationState(visualElement) {
                    ...
                    function animateChanges(changedActiveType) {
                        ...
                        for (let i = 0; i < numAnimationTypes; i++) {
                            ...
                            const definitionList = Array.isArray(prop)
                                ? prop
                                : [prop]
                            ...
                            for (const key in allKeys) {
                                ...
                                ;(valueHasChanged =
                                    isKeyframesTarget(next) &&
                                    isKeyframesTarget(prev)
                            ...
                            Feature: class AnimationFeature extends Feature {
                                constructor(node) {
                                    super(node),
                                        node.animationState ||
                                            (node.animationState =
                                                createAnimationState(node))
                                }
                                updateAnimationControlsSubscription() {
                                    const { animate } = this.node.getProps()
                                    isAnimationControls(animate) &&
                                        (this.unmountControls =
                                            animate.subscribe(this.node))
                                }
                                mount() {
                    ...
                    constructor(
                        ...
                        if (
                            ...
                            (this.handlePointerUp = (event, info) => {
                                this.end()
                                const { onEnd, onSessionEnd, resumeAnimation } =
                                    this.handlers
                                if (
                        ...
                        onSessionStart &&
                            onSessionStart(
                                event,
                                getPanInfo(initialInfo, this.history),
                            ),
                ...
                function calcAxisDelta(delta, source, target, origin = 0.5) {
                    ;(delta.origin = origin),
                        ...
                        (delta.translate =
                            ...
                            delta.originPoint),
                        ((delta.scale >= SCALE_MIN &&
                            delta.scale <= SCALE_MAX) ||
                            isNaN(delta.scale)) &&
                            (delta.scale = 1),
                ...
                class VisualElementDragControls {
                    ...
                    start(originEvent, { snapToCursor = !1 } = {}) {
                        ...
                        if (presenceContext && !1 === presenceContext.isPresent)
                            return
                    ...
                    cancel() {
                        this.isDragging = !1
                        const { projection, animationState } =
                            this.visualElement
                        ...
                        !dragPropagation &&
                            ...
                            (this.openGlobalLock = null)),
                            animationState &&
                                animationState.setActive('whileDrag', !1)
                    }
                    updateAxis(axis, _point, offset) {
                        const { drag } = this.getProps()
                        if (
                            !offset ||
                            !shouldDrag(axis, drag, this.currentDirection)
                        )
                            return
                        ...
                        this.constraints &&
                            ...
                            (next = (function applyConstraints(
                                point,
                                { min, max },
                                elastic,
                            ) {
                    ...
                    resolveConstraints() {
                        var _a
                        const { dragConstraints, dragElastic } =
                                this.getProps(),
                            layout =
                                this.visualElement.projection &&
                        ...
                        dragConstraints && isRefObject(dragConstraints)
                            ...
                            : (this.constraints =
                                  ...
                                  (function calcRelativeConstraints(
                                      ...
                                      return {
                                          x: calcRelativeAxisConstraints(
                                              layoutBox.x,
                                              left,
                                              right,
                                          ),
                                          y: calcRelativeAxisConstraints(
                                              layoutBox.y,
                                              top,
                                              bottom,
                                          ),
                                ...
                                return (
                                    !1 === dragElastic
                                        ...
                                        : !0 === dragElastic &&
                                          (dragElastic = defaultElastic),
                                    {
                                        x: resolveAxisElastic(
                                            dragElastic,
                                            'left',
                                            'right',
                                        ),
                                        y: resolveAxisElastic(
                                            dragElastic,
                                            'top',
                                            'bottom',
                                        ),
                    ...
                    pauseAnimation() {
                        eachAxis((axis) => {
                            ...
                            return null ===
                                (_a =
                                    this.getAxisMotionValue(axis).animation) ||
                                void 0 === _a
                                ? void 0
                                : _a.pause()
                        })
                    ...
                    getAnimationState(axis) {
                        var _a
                        return null ===
                            (_a = this.getAxisMotionValue(axis).animation) ||
                            void 0 === _a
                            ? void 0
                            : _a.state
                    }
                    ...
                    snapToCursor(point) {
                        eachAxis((axis) => {
                            ...
                            if (projection && projection.layout) {
                                ...
                                axisValue.set(
                                    point[axis] - mixNumber(min, max, 0.5),
                                )
                            }
                        })
                    }
                    scalePositionWithinConstraints() {
                        ...
                        eachAxis((axis) => {
                            ...
                            if (axisValue && !1 !== this.constraints) {
                                ...
                                boxProgress[axis] = (function calcOrigin(
                                    source,
                                    target,
                                ) {
                                    let origin = 0.5
                        ...
                        ;(this.visualElement.current.style.transform =
                            ...
                            eachAxis((axis) => {
                                ...
                                axisValue.set(
                                    mixNumber(min, max, boxProgress[axis]),
                                )
                            })
                    }
                    addListeners() {
                ...
                var jsx_runtime = __webpack_require__(
                    ...
                    context_PresenceContext = __webpack_require__(
                        './node_modules/framer-motion/dist/es/context/PresenceContext.mjs',
                    )
                var LayoutGroupContext = __webpack_require__(
                    './node_modules/framer-motion/dist/es/context/LayoutGroupContext.mjs',
                ...
                function MeasureLayout(props) {
                    const [isPresent, safeToRemove] = (function usePresence() {
                            const context = (0, react.useContext)(
                                context_PresenceContext.O,
                            )
                            if (null === context) return [!0, null]
                            const { isPresent, onExitComplete, register } =
                                    context,
                                id = (0, react.useId)()
                        ...
                        layoutGroup = (0, react.useContext)(
                            LayoutGroupContext.p,
                        )
                    return (0, jsx_runtime.jsx)(MeasureLayoutWithContext, {
                        ...props,
                        layoutGroup,
                        switchLayoutGroup: (0, react.useContext)(
                ...
                function boxEqualsRounded(a, b) {
                    return (
                        axisEqualsRounded(a.x, b.x) &&
                        axisEqualsRounded(a.y, b.y)
                    )
                }
                        ...
                        if (
                            ...
                            prevLead.instance && prevLead.scheduleRender(),
                                ...
                                preserveFollowOpacity &&
                                    (node.resumeFrom.preserveOpacity = !0),
                                prevLead.snapshot &&
                                    ((node.snapshot = prevLead.snapshot),
                                    (node.snapshot.latestValues =
                                        prevLead.animationValues ||
                                        prevLead.latestValues)),
                                node.root &&
                                    node.root.isUpdating &&
                                    (node.isLayoutDirty = !0)
                ...
                function resolveMotionValue(value) {
                    const unwrappedValue = isMotionValue(value)
                        ? value.get()
                        : value
                ...
                function createProjectionNode({
                    ...
                    return class ProjectionNode {
                        ...
                        mount(
                            instance,
                            isLayoutDirty = this.root.hasTreeAnimated,
                        ) {
                            ...
                            const { layoutId, layout, visualElement } =
                                this.options
                            if (
                                (visualElement &&
                        ...
                        startUpdate() {
                            this.isUpdateBlocked() ||
                                ((this.isUpdating = !0),
                                this.nodes &&
                                    this.nodes.forEach(resetSkewAndRotation),
                                this.animationId++)
                        }
                        ...
                        measure(removeTransform = !0) {
                            ...
                            return (
                                removeTransform &&
                                    (layoutBox =
                                        this.removeTransform(layoutBox)),
                        ...
                        resolveTargetDelta(forceRecalculation = !1) {
                            ...
                            this.isProjectionDirty ||
                                (this.isProjectionDirty =
                                    lead.isProjectionDirty),
                                this.isTransformDirty ||
                                    (this.isTransformDirty =
                                        lead.isTransformDirty),
                                this.isSharedProjectionDirty ||
                                    (this.isSharedProjectionDirty =
                                        lead.isSharedProjectionDirty)
                            const isShared =
                        ...
                        setAnimationOrigin(
                            delta,
                            hasOnlyRelativeTargetChanged = !1,
                        ) {
                            const snapshot = this.snapshot,
                                snapshotLatestValues = snapshot
                        ...
                        applyTransformsToTarget() {
                            ...
                            if (targetWithTransforms && target && layout) {
                                if (
                                    ...
                                    const xLength = calcLength(
                                        this.layout.layoutBox.x,
                                    )
                                    ;(target.x.min = lead.target.x.min),
                                        (target.x.max = target.x.min + xLength)
                                    const yLength = calcLength(
                            ...
                            node.promote({
                                ...
                                preserveFollowOpacity:
                                    config && config.shouldPreserveFollowOpacity
                                        ? config.shouldPreserveFollowOpacity(
                                              node,
                                          )
                                        : void 0,
                            })
                            ...
                            this.applyTransformsToTarget(),
                                (styles.transform =
                                    (function buildProjectionTransform(
                                        ...
                                        let transform = ''
                                        const xTranslate =
                                                delta.x.translate / treeScale.x,
                                            yTranslate =
                                                delta.y.translate / treeScale.y,
                                            zTranslate =
                                                (null == latestTransform
                                                    ? void 0
                                                    : latestTransform.z) || 0
                                        if (
                                            ((xTranslate ||
                        ...
                        resetTree() {
                            this.root.nodes.forEach((node) => {
                                var _a
                                return null === (_a = node.currentAnimation) ||
                                    void 0 === _a
                                    ? void 0
                                    : _a.stop()
                            }),
                ...
                function notifyLayoutUpdate(node) {
                    ...
                    if (
                        ...
                        if (!node.resumeFrom) {
                            const relativeParent =
                                node.getClosestProjectingParent()
                ...
                function hasOpacityCrossfade(node) {
                    return (
                        ...
                        void 0 !== node.animationValues.opacityExit
                    )
                }
                ...
                const DocumentProjectionNode = createProjectionNode({
                    ...
                    HTMLProjectionNode = createProjectionNode({
                        ...
                        checkIsScrollRoot: (instance) =>
                            Boolean(
                                'fixed' ===
                                    window.getComputedStyle(instance).position,
                            ),
                    }),
                    drag = {
                        pan: {
                            Feature: class PanGesture extends Feature {
                                ...
                                createPanHandlers() {
                                    ...
                                    return {
                                        onSessionStart:
                                            asyncHandler(onPanSessionStart),
                            ...
                            Feature: class DragGesture extends Feature {
                                constructor(node) {
                                    super(node),
                                        ...
                                        (this.controls =
                                            new VisualElementDragControls(node))
                                }
                                mount() {
                                    const { dragControls } =
                                        this.node.getProps()
                ...
                function addHoverEvent(node, isActive) {
                    const eventName = isActive
                            ? 'pointerenter'
                            : 'pointerleave',
                        callbackName = isActive ? 'onHoverStart' : 'onHoverEnd'
                    return addPointerEvent(
                        node.current,
                        eventName,
                        (event, info) => {
                            if ('touch' === event.pointerType || isDragActive())
                                return
                ...
                const isNodeOrChild = (parent, child) =>
                    !!child &&
                    (parent === child ||
                        isNodeOrChild(parent, child.parentElement))
                function fireSyntheticPointerEvent(name, handler) {
                    if (!handler) return
                    const syntheticPointerEvent = new PointerEvent(
                        'pointer' + name,
                    )
                    handler(
                        syntheticPointerEvent,
                        extractEventInfo(syntheticPointerEvent),
                    )
                }
                ...
                function observeIntersection(element, options, callback) {
                    const rootInteresectionObserver =
                        (function initIntersectionObserver({
                            root,
                            ...options
                        }) {
                            const lookupRoot = root || document
                            observers.has(lookupRoot) ||
                ...
                function useVisualElement(
                    ...
                    !visualElement ||
                        ...
                        !ProjectionNodeConstructor ||
                        ('html' !== visualElement.type &&
                            'svg' !== visualElement.type) ||
                    ...
                    const optimisedAppearId =
                        ...
                        wantsHandoff = (0, react.useRef)(
                            Boolean(optimisedAppearId) &&
                                !(null ===
                                    (_a = window.MotionHandoffIsComplete) ||
                                void 0 === _a
                                    ? void 0
                                    : _a.call(window, optimisedAppearId)) &&
                                (null ===
                                    (_b = window.MotionHasOptimisedAnimation) ||
                                void 0 === _b
                                    ? void 0
                ...
                function isVariantNode(props) {
                    return Boolean(
                        isControllingVariants(props) || props.variants,
                    )
                }
                ...
                const motionComponentSymbol = Symbol.for(
                ...
                function createRendererMotionComponent({
                    ...
                    return (
                        (ForwardRefMotionComponent[motionComponentSymbol] =
                            Component),
                        ForwardRefMotionComponent
                    )
                }
                function useLayoutId({ layoutId }) {
                    const layoutGroupId = (0, react.useContext)(
                        LayoutGroupContext.p,
                    ).id
                ...
                function makeLatestValues(
                    ...
                    const variantToSet = isInitialAnimationBlocked
                        ? animate
                        : initial
                    if (
                        variantToSet &&
                        ...
                        for (let i = 0; i < list.length; i++) {
                            ...
                            if (resolved) {
                                const { transitionEnd, transition, ...target } =
                                    resolved
                                for (const key in target) {
                    ...
                    attrs.transform &&
                        ...
                        dimensions &&
                            ...
                            (style.transformOrigin =
                                (function calcSVGTransformOrigin(
                                    dimensions,
                                    originX,
                                    originY,
                                ) {
                                    return `${transform_origin_calcOrigin(
                                        originX,
                                        dimensions.x,
                                        dimensions.width,
                                    )} ${transform_origin_calcOrigin(
                                        originY,
                                        dimensions.y,
                                        dimensions.height,
                                    )}`
                    ...
                    return (
                        ...
                        const visualProps = (
                            ...
                            filteredProps = (function filterProps(
                                ...
                                for (const key in props)
                                    ('values' === key &&
                                        'object' == typeof props.values) ||
                                        ((shouldForward(key) ||
                                            (!0 === forwardMotionProps &&
                                                isValidMotionProp(key)) ||
                                            (!isDom &&
                                                !isValidMotionProp(key)) ||
                                            (props.draggable &&
                ...
                function createMotionComponentFactory(
                    ...
                    return function createMotionComponent(
                        Component,
                        { forwardMotionProps } = { forwardMotionProps: !1 },
                    ) {
                ...
                class VisualElement {
                    ...
                    constructor(
                        ...
                        ;(this.latestValues = latestValues),
                            ...
                            (this.blockInitialAnimation = Boolean(
                                blockInitialAnimation,
                            )),
                            ...
                            (this.manuallyAnimateOnMount = Boolean(
                    ...
                    unmount() {
                        visualElementStore.delete(this.current),
                            ...
                            this.valueSubscriptions.forEach((remove) =>
                                remove(),
                            ),
                        ...
                        for (const key in this.features) {
                            ...
                            feature &&
                                (feature.unmount(), (feature.isMounted = !1))
                        }
                        this.current = null
                    }
                            ...
                            removeOnChange = value.on(
                                ...
                                (latestValue) => {
                                    ;(this.latestValues[key] = latestValue),
                                        ...
                                        valueIsTransform &&
                                            this.projection &&
                                            (this.projection.isTransformDirty =
                                                !0)
                                },
                            ),
                    ...
                    update(props, presenceContext) {
                        ...
                        for (let i = 0; i < propEventHandlers.length; i++) {
                            ...
                            listener &&
                                (this.propEventSubscriptions[key] = this.on(
                                    key,
                                    listener,
                                ))
                        }
                        ...
                        if (closestVariantNode)
                            return (
                                closestVariantNode.variantChildren &&
                                    closestVariantNode.variantChildren.add(
                                        child,
                                    ),
                                () =>
                                    closestVariantNode.variantChildren.delete(
                                        child,
                                    )
                            )
                    }
                    ...
                    removeValue(key) {
                        ...
                        unsubscribe &&
                            ...
                            this.removeValueFromRenderState(
                                key,
                                this.renderState,
                            )
                    }
                    ...
                    readValue(key, target) {
                        ...
                        let value =
                            void 0 === this.latestValues[key] && this.current
                                ? null !==
                                      (_a = this.getBaseTargetFromProps(
                                          this.props,
                                          key,
                                      )) && void 0 !== _a
                                    ? _a
                    ...
                    getBaseTarget(key) {
                        ...
                        const target = this.getBaseTargetFromProps(
                            this.props,
                            key,
                        )
                ...
                class HTMLVisualElement extends DOMVisualElement {
                    ...
                    readValueFromInstance(instance, key) {
                        ...
                        {
                            const computedStyle = (function getComputedStyle(
                                    element,
                                ) {
                    ...
                    handleChildMotionValue() {
                        ...
                        isMotionValue(children) &&
                            (this.childSubscription = children.on(
                                'change',
                                (latest) => {
                                    this.current &&
                ...
                class SVGVisualElement extends DOMVisualElement {
                    ...
                    readValueFromInstance(instance, key) {
                        ...
                        return (
                            (key = camelCaseAttributes.has(key)
                                ? key
                                : camelToDash(key)),
                ...
                const motion = createDOMMotionComponentProxy(
