    ...
    [1664],
    {
            ...
            function getDomainLocale(path, locale, locales, domainLocales) {
                if (process.env.__NEXT_I18N_SUPPORT) {
                    const normalizeLocalePath = __webpack_require__(
                        ...
                        target =
                            locale ||
                            normalizeLocalePath(path, locales).detectedLocale,
                    ...
                    const { href, as } = _react.default.useMemo(() => {
                            if (!pagesRouter) {
                                ...
                                return {
                                    href: resolvedHref,
                                    as: asProp
                                        ? formatStringOrUrl(asProp)
                                        : resolvedHref,
                                }
                            }
                            const [resolvedHref, resolvedAs] = (0,
                            _resolvehref.resolveHref)(pagesRouter, hrefProp, !0)
                            return {
                                href: resolvedHref,
                                as: asProp
                                    ? (0, _resolvehref.resolveHref)(
                                          pagesRouter,
                                          asProp,
                                      )
            ...
            const _removetrailingslash = __webpack_require__(
                ...
                normalizePathTrailingSlash = (path) => {
                    if (
                        ...
                        return path
                    const { pathname, query, hash } = (0, _parsepath.parsePath)(
                        path,
                    )
            ...
            function resolveHref(router, href, resolveAs) {
                ...
                const urlProtoMatch = urlAsString.match(/^[a-zA-Z]{1,}:\/\//),
                    urlAsStringNoProto = urlProtoMatch
                        ...
                        : urlAsString
                if (
                    (urlAsStringNoProto.split('?', 1)[0] || '').match(
                        /(\/\/|\\)/,
                    )
                ) {
                    console.error(
                ...
                const { id, observer, elements } = (function createObserver(
                    ...
                    const id = {
                        ...
                        existing = idList.find(
                            (obj) =>
                                obj.root === id.root &&
                                obj.margin === id.margin,
                        )
                    let instance
                    if (
                        existing &&
                        ((instance = observers.get(existing)), instance)
                    )
                        return instance
            ...
            function useIntersection(param) {
                ...
                ;(0, _react.useEffect)(() => {
                    if (hasIntersectionObserver) {
                        ...
                        return () =>
                            (0, _requestidlecallback.cancelIdleCallback)(
                                idleCallback,
                            )
                    }
                }, [
                ...
                function extractInterceptionRouteInformation(path) {
                    ...
                    switch (
                        ...
                        case '(...)':
                            ...
                            break
                        case '(..)(..)':
                            const splitInterceptingRoute =
                                interceptingRoute.split('/')
            ...
            function formatUrl(urlObj) {
                ...
                ;(auth = auth
                    ...
                    query &&
                        'object' == typeof query &&
                        (query = String(
                            _querystring.urlQueryToSearchParams(query),
                        ))
        ...
        './node_modules/next/dist/shared/lib/router/utils/route-regex.js': (
            ...
            function getParametrizedRoute(route) {
                const segments = (0, _removetrailingslash.removeTrailingSlash)(
                        route,
                    )
                        .slice(1)
                        .split('/'),
                ...
                return {
                    parameterizedRoute: segments
                        .map((segment) => {
                            const markerMatch =
                                    _interceptionroutes.INTERCEPTION_ROUTE_MARKERS.find(
            ...
            function getSafeKeyFromSegment(param) {
                ...
                return (
                    ...
                    (routeKeys[cleanedKey] = keyPrefix
                        ? '' + keyPrefix + key
                        : '' + key),
                    repeat
                        ? optional
