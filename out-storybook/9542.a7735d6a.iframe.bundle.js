/*! For license information please see 9542.a7735d6a.iframe.bundle.js.LICENSE.txt */
'use strict'
    ...
    [9542],
    {
        './node_modules/@radix-ui/react-accordion/dist/index.mjs': (
            ...
            __webpack_require__.d(__webpack_exports__, {
                VY: () => $1bf158f521e1b1b4$export$7c6e2c02157bb7d2,
                h4: () => $1bf158f521e1b1b4$export$8b251419efc915eb,
                ck: () => $1bf158f521e1b1b4$export$6d08773d2e66f8f2,
                fC: () => $1bf158f521e1b1b4$export$be92b6f5f03c0fe9,
                xz: () => $1bf158f521e1b1b4$export$41fb9f06171c75f4,
            })
            ...
            var react_direction_dist = __webpack_require__(
            ...
            const $1bf158f521e1b1b4$var$ACCORDION_KEYS = [
                ...
                [
                    $1bf158f521e1b1b4$var$Collection,
                    $1bf158f521e1b1b4$var$useCollection,
                    $1bf158f521e1b1b4$var$createCollectionScope,
                ] = (0, react_collection_dist.B)('Accordion'),
                [
                    $1bf158f521e1b1b4$var$createAccordionContext,
                    $1bf158f521e1b1b4$export$9748edc328a73be1,
                ] = (0, dist.b)('Accordion', [
                    $1bf158f521e1b1b4$var$createCollectionScope,
                    $409067139f391064$export$952b32dcbe73087a,
                ]),
                $1bf158f521e1b1b4$var$useCollapsibleScope =
                    $409067139f391064$export$952b32dcbe73087a(),
                $1bf158f521e1b1b4$export$a766cd26d0d69044 = react.forwardRef(
                    (props, forwardedRef) => {
                        const { type, ...accordionProps } = props,
                            singleProps = accordionProps,
                            multipleProps = accordionProps
                        return react.createElement(
                            $1bf158f521e1b1b4$var$Collection.Provider,
                            { scope: props.__scopeAccordion },
                            'multiple' === type
                                ? react.createElement(
                                      $1bf158f521e1b1b4$var$AccordionImplMultiple,
                                      (0, esm_extends.Z)({}, multipleProps, {
                                          ref: forwardedRef,
                                      }),
                                  )
                                : react.createElement(
                                      $1bf158f521e1b1b4$var$AccordionImplSingle,
            ...
            $1bf158f521e1b1b4$export$a766cd26d0d69044.propTypes = {
                type(props) {
                    ...
                    return props.type &&
                        !['single', 'multiple'].includes(props.type)
                        ? new Error(
                              'Invalid prop `type` supplied to `Accordion`. Expected one of `single | multiple`.',
                          )
                        : 'multiple' === props.type && 'string' == typeof value
                          ? new Error(
                                'Invalid prop `type` supplied to `Accordion`. Expected `single` when `defaultValue` or `value` is type `string`.',
                            )
                          : 'single' === props.type && Array.isArray(value)
                            ? new Error(
            ...
            const [
                    $1bf158f521e1b1b4$var$AccordionValueProvider,
                    $1bf158f521e1b1b4$var$useAccordionValueContext,
                ] = $1bf158f521e1b1b4$var$createAccordionContext('Accordion'),
                [
                ...
                $1bf158f521e1b1b4$var$AccordionImplSingle = react.forwardRef(
                    (props, forwardedRef) => {
                        const {
                                value: valueProp,
                                defaultValue,
                        ...
                        return react.createElement(
                            ...
                            react.createElement(
                                $1bf158f521e1b1b4$var$AccordionCollapsibleProvider,
                                { scope: props.__scopeAccordion, collapsible },
                                react.createElement(
                                    $1bf158f521e1b1b4$var$AccordionImpl,
                                    (0, esm_extends.Z)(
                                        {},
                                        accordionSingleProps,
                                        { ref: forwardedRef },
                ...
                $1bf158f521e1b1b4$var$AccordionImplMultiple = react.forwardRef(
                    (props, forwardedRef) => {
                        const {
                                value: valueProp,
                                defaultValue,
                ...
                [
                    $1bf158f521e1b1b4$var$AccordionImplProvider,
                    $1bf158f521e1b1b4$var$useAccordionContext,
                ] = $1bf158f521e1b1b4$var$createAccordionContext('Accordion'),
                $1bf158f521e1b1b4$var$AccordionImpl = react.forwardRef(
                    (props, forwardedRef) => {
                        const {
                                __scopeAccordion,
                                disabled,
                            ...
                            isDirectionLTR =
                                'ltr' === (0, react_direction_dist.gm)(dir),
                            handleKeyDown = (0, primitive_dist.M)(
                                props.onKeyDown,
                                (event) => {
                                    var _triggerCollection$cl
                                    if (
                                        !$1bf158f521e1b1b4$var$ACCORDION_KEYS.includes(
                                            event.key,
                                        )
                                    )
                                        return
                                    ...
                                    null ===
                                        (_triggerCollection$cl =
                                            triggerCollection[
                                                nextIndex % triggerCount
                                            ].ref.current) ||
                                        void 0 === _triggerCollection$cl ||
                                        _triggerCollection$cl.focus()
                                },
                            )
                        return react.createElement(
                            $1bf158f521e1b1b4$var$AccordionImplProvider,
                            ...
                            react.createElement(
                                $1bf158f521e1b1b4$var$Collection.Slot,
                                { scope: __scopeAccordion },
                                react.createElement(
                                    react_primitive_dist.WV.div,
                                    (0, esm_extends.Z)({}, accordionProps, {
                ...
                [
                    $1bf158f521e1b1b4$var$AccordionItemProvider,
                    $1bf158f521e1b1b4$var$useAccordionItemContext,
                ] =
                    $1bf158f521e1b1b4$var$createAccordionContext(
                        'AccordionItem',
                    ),
                $1bf158f521e1b1b4$export$d99097c13d4dac9f = react.forwardRef(
                    (props, forwardedRef) => {
                        const {
                                __scopeAccordion,
                                value,
                            ...
                            open1 =
                                (value && valueContext.value.includes(value)) ||
                                !1,
                            disabled =
                                accordionContext.disabled || props.disabled
                        return react.createElement(
                            $1bf158f521e1b1b4$var$AccordionItemProvider,
                            {
                                scope: __scopeAccordion,
                            ...
                            react.createElement(
                                ...
                                (0, esm_extends.Z)(
                                    {
                                        'data-orientation':
                                            accordionContext.orientation,
                                        'data-state':
                                            $1bf158f521e1b1b4$var$getState(
                                                open1,
                                            ),
                                    },
                                    collapsibleScope,
                ...
                $1bf158f521e1b1b4$export$5e3e5deaaf81ee41 = react.forwardRef(
                    (props, forwardedRef) => {
                ...
                $1bf158f521e1b1b4$export$94e939b1f85bdd73 = react.forwardRef(
                    (props, forwardedRef) => {
                        ...
                        return react.createElement(
                            $1bf158f521e1b1b4$var$Collection.ItemSlot,
                            { scope: __scopeAccordion },
                            react.createElement(
                                $409067139f391064$export$41fb9f06171c75f4,
                                (0, esm_extends.Z)(
                ...
                $1bf158f521e1b1b4$export$985b9a77379b54a0 = react.forwardRef(
                    (props, forwardedRef) => {
            ...
            const $1bf158f521e1b1b4$export$be92b6f5f03c0fe9 =
